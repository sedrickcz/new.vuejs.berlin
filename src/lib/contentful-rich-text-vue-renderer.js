// imported from https://github.com/paramander/contentful-rich-text-vue-renderer
// TODO: wait for publication of hyperlink fix and switch back to npm package
...
const defaultNodeRenderers = {
    ...
    [BLOCKS.EMBEDDED_ASSET]: (node, key, h, next) => {
        ...
        return h('img', { key, attrs: { alt: title, src: file.url } }, next(node.content, key, h, next))
    },
